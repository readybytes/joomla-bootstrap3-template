...
?>
	...
	<?php if ($useDefList && ($info == 0 || $info == 2)) : ?>
		<div class="article-info text-muted">
			...
			<dt class="article-info-term hide"><?php echo JText::_('COM_CONTENT_ARTICLE_INFO'); ?></dt>
	...
	<?php if ($images->image_fulltext_caption):
		...
		echo $captionClass="caption".' title="' .htmlspecialchars($images->image_fulltext_caption) . '"';
	endif; ?>
	src="<?php echo htmlspecialchars($images->image_fulltext); ?>" alt="<?php echo htmlspecialchars($images->image_fulltext_alt); ?>" itemprop="image" class="img-responsive <?php echo $captionClass;?>"/> </div>
	<?php endif; ?>
	<?php
	if (!empty($this->item->pagination) && $this->item->pagination && !$this->item->paginationposition && !$this->item->paginationrelative):
		echo $this->item->pagination;
